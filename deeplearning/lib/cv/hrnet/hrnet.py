...
class PoseHighResolutionNet(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        self.final_layer = nn.Conv2d(
            ...
            stride=(1, 1),
            padding=(1, 1) if extra["FINAL_CONV_KERNEL"] == 3 else (0, 0),
        )
    ...
    @staticmethod
    def _make_stage(layer_config, num_in_channels, multi_scale_output=True):
    ...
    def init_weights(self, pretrained=""):
        ...
        if os.path.isfile(pretrained):
            ...
            need_init_state_dict = collections.OrderedDict()
